...
export const LineChart = (props: Props) => {
  ...
  return (
    ...
    >
      ...
      <div>
        {
          !graphWidth ? <div className='undp-loader' style={{ margin: 'auto' }} />
            : (
              <>
                {
                  values.length === 0 ? <h6 className='undp-typography'>No Data Available</h6>
                    : (
                      <>
                        ...
                        {
                          data.series === '***' || data['Custodian_Agency(ies)'] === 'Country Office' ? <div style={{ fontSize: '0.875rem', opacity: 0.7 }}>Data Source: Country office</div> : <a style={{ fontSize: '0.875rem', opacity: 0.7 }} href={`https://unstats.un.org/sdgs/dataportal/countryprofiles/${countryCode}`} className='undp-style margin-top-05' target='_blank' rel='noreferrer'>Data Source: UNStats</a>
                        }
                      </>
                    )
                }
